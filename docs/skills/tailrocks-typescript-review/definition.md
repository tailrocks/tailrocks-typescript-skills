---
title: "Tailrocks: tailrocks-typescript-review — Skill definition"
description: "Verbatim definition of tailrocks-typescript-review."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-typescript-review/SKILL.md)
...
Apply [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-typescript-review/references/runtime-trust.md), then load only relevant
