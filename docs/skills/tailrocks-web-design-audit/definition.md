---
title: "Tailrocks: tailrocks-web-design-audit — Skill definition"
description: "Verbatim definition of tailrocks-web-design-audit."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design-audit/SKILL.md)
...
Read [`runtime-trust.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design-audit/references/runtime-trust.md),
[`design-routes.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design-audit/references/design-routes.md),
[`screen-package.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design-audit/references/screen-package.md), and
[`web-screen-craft.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design-audit/references/web-screen-craft.md). These generated local
