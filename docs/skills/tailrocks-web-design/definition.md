---
title: "Tailrocks: tailrocks-web-design — Skill definition"
description: "Verbatim definition of tailrocks-web-design."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design/SKILL.md)
...
1. **Collect screens.** Purpose, states (default, empty, loading, error),
   ...
   [`web-screen-craft.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design/references/web-screen-craft.md) before layout,
...
2. **Build the design routes.** Read
   [`design-routes.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design/references/design-routes.md); copy the route,
   fixture, and registry shapes from [`templates/`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design/templates/). Each
...
4. **Wire the handoff.** Read
   [`screen-package.md`](https://github.com/tailrocks/tailrocks-typescript-skills/blob/main/skills/tailrocks-web-design/references/screen-package.md) for the manifest
